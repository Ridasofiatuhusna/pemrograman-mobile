            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                  image: NetworkImage(
                    "https://i0.wp.com/ariefpokto.com/wp-content/uploads/2018/06/20180626114048_IMG_3245-01-576x384.jpeg?fit=576%2C384&ssl=1",
                  ),
                  fit: BoxFit.cover,
                ),
              ),
            ...
            const Positioned.fill(
              child: Align(
                ...
                child: Padding(
                  ...
                  child: Text(
                    "CIPANAS SUKASONO DESTINASI WISATA YANG POPULER",
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                    ),
                          ...
                          children: [
                            ...
                            const Expanded(
                              child: Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                  "Pangatikan adalah salah satu kecamatan di garut",
                                  maxLines: 3,
                                ),
                              ),
                            ),
